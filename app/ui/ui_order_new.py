...
################################################################################
## Form generated from reading UI file 'order_newCRbAkv.ui'
##
...
"    outline: 0;\n"
"}")
        self.gridLayout_5 = QGridLayout(OrderTab)
        ...
        self.btn_clone = QPushButton(self.top_widget)
        self.btn_clone.setObjectName(u"btn_clone")
        sizePolicy1.setHeightForWidth(self.btn_clone.sizePolicy().hasHeightForWidth())
        self.btn_clone.setSizePolicy(sizePolicy1)
        icon2 = QIcon()
        icon2.addFile(u"icons/layers.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_clone.setIcon(icon2)

        self.horizontalLayout_2.addWidget(self.btn_clone)
        ...
        icon3 = QIcon()
        icon3.addFile(u"icons/export.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_save_2.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u"icons/document.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_document.setIcon(icon4)
        ...
        icon6 = QIcon()
        icon6.addFile(u"icons/plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_add_door.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"icons/menu.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_menu.setIcon(icon7)

        self.horizontalLayout_2.addWidget(self.btn_menu)


        self.gridLayout_5.addWidget(self.top_widget, 0, 0, 1, 2)
        ...
        sizePolicy2.setHeightForWidth(self.rigth_widget.sizePolicy().hasHeightForWidth())
        self.rigth_widget.setSizePolicy(sizePolicy2)
...
"            }")
        ...
        self.right_pannel_content.setGeometry(QRect(0, 0, 290, 1124))
        ...
        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.height)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.inp_height)

        self.long_2 = QLabel(self.right_pannel_content)
        self.long_2.setObjectName(u"long_2")

        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.long_2)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.inp_width)

        self.longL2 = QLabel(self.right_pannel_content)
        self.longL2.setObjectName(u"longL2")

        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.longL2)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.inp_quide_long)

        self.date = QLabel(self.right_pannel_content)
        self.date.setObjectName(u"date")

        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.date)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.inp_date)

        self.norder = QLabel(self.right_pannel_content)
        self.norder.setObjectName(u"norder")

        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.norder)
        ...
        sizePolicy2.setHeightForWidth(self.norder_2.sizePolicy().hasHeightForWidth())
        self.norder_2.setSizePolicy(sizePolicy2)
        ...
        self.formLayout.setLayout(5, QFormLayout.FieldRole, self.horizontalLayout_8)

        self.dateout = QLabel(self.right_pannel_content)
        self.dateout.setObjectName(u"dateout")

        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.dateout)
        ...
        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.inp_date_uot)
        ...
        self.formLayout.setWidget(7, QFormLayout.LabelRole, self.discription_10)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.inp_overlap_count)
        ...
        self.formLayout.setWidget(9, QFormLayout.LabelRole, self.discription_11)
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.c_bot_system)
        ...
        self.formLayout.setWidget(10, QFormLayout.LabelRole, self.discription_12)
        ...
        self.formLayout.setWidget(10, QFormLayout.FieldRole, self.c_guide)
        ...
        self.formLayout.setWidget(11, QFormLayout.LabelRole, self.lbl_guide_decor)
        ...
        self.formLayout.setWidget(11, QFormLayout.FieldRole, self.c_guide_decor)

        self.discription_5 = QLabel(self.right_pannel_content)
        self.discription_5.setObjectName(u"discription_5")
        self.discription_5.setAlignment(Qt.AlignCenter)

        self.formLayout.setWidget(0, QFormLayout.SpanningRole, self.discription_5)
        ...
        self.gridLayout_5.addWidget(self.rigth_widget, 0, 2, 3, 1)

        self.l_widget = QWidget(OrderTab)
...
"	background-color: rgb(39, 50, 56);\n"
"}")
        self.horizontalLayout = QHBoxLayout(self.l_widget)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.scrollArea_2 = QScrollArea(self.l_widget)
...
"            }")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 197, 948))
        sizePolicy9 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        sizePolicy9.setHorizontalStretch(0)
        sizePolicy9.setVerticalStretch(0)
        sizePolicy9.setHeightForWidth(self.scrollAreaWidgetContents_2.sizePolicy().hasHeightForWidth())
        self.scrollAreaWidgetContents_2.setSizePolicy(sizePolicy9)
        ...
        self.bin_1c_bot_profile = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_bot_profile.setObjectName(u"bin_1c_bot_profile")
        sizePolicy5.setHeightForWidth(self.bin_1c_bot_profile.sizePolicy().hasHeightForWidth())
        self.bin_1c_bot_profile.setSizePolicy(sizePolicy5)
        self.bin_1c_bot_profile.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_bot_profile, 8, 2, 1, 1)

        self.bin_1c_bot_guide = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_bot_guide.setObjectName(u"bin_1c_bot_guide")
        sizePolicy5.setHeightForWidth(self.bin_1c_bot_guide.sizePolicy().hasHeightForWidth())
        self.bin_1c_bot_guide.setSizePolicy(sizePolicy5)
        self.bin_1c_bot_guide.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_bot_guide, 2, 2, 1, 1)
        ...
        self.in_1c_top_profile = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_top_profile.setObjectName(u"in_1c_top_profile")
        self.in_1c_top_profile.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_top_profile.setDecimals(1)
        self.in_1c_top_profile.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_top_profile, 7, 3, 1, 1)
        ...
        self.color_27 = QLabel(self.scrollAreaWidgetContents_2)
        self.color_27.setObjectName(u"color_27")
        self.color_27.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.color_27, 22, 0, 1, 4)

        self.bin_1c_vertical = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_vertical.setObjectName(u"bin_1c_vertical")
        sizePolicy5.setHeightForWidth(self.bin_1c_vertical.sizePolicy().hasHeightForWidth())
        self.bin_1c_vertical.setSizePolicy(sizePolicy5)
        self.bin_1c_vertical.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_vertical, 10, 2, 1, 1)

        self.bin_1c_plug = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_plug.setObjectName(u"bin_1c_plug")
        sizePolicy5.setHeightForWidth(self.bin_1c_plug.sizePolicy().hasHeightForWidth())
        self.bin_1c_plug.setSizePolicy(sizePolicy5)
        self.bin_1c_plug.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_plug, 5, 2, 1, 1)
        ...
        self.in_1c_sealant = QSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_sealant.setObjectName(u"in_1c_sealant")
        self.in_1c_sealant.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_sealant.setMaximum(9999)

        self.gridLayout.addWidget(self.in_1c_sealant, 14, 3, 1, 1)

        self.in_1c_top_guide = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_top_guide.setObjectName(u"in_1c_top_guide")
        self.in_1c_top_guide.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_top_guide.setDecimals(1)
        self.in_1c_top_guide.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_top_guide, 1, 3, 1, 1)
        ...
        self.in_1c_top_movable = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_top_movable.setObjectName(u"in_1c_top_movable")
        self.in_1c_top_movable.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_top_movable.setDecimals(1)
        self.in_1c_top_movable.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_top_movable, 3, 3, 1, 1)

        self.in_1c_shlegel = QSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_shlegel.setObjectName(u"in_1c_shlegel")
        self.in_1c_shlegel.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_shlegel.setMaximum(9999)

        self.gridLayout.addWidget(self.in_1c_shlegel, 16, 3, 1, 1)

        self.btn_add_material_1c = QPushButton(self.scrollAreaWidgetContents_2)
        self.btn_add_material_1c.setObjectName(u"btn_add_material_1c")
        icon8 = QIcon()
        icon8.addFile(u"icons/sircle-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_add_material_1c.setIcon(icon8)

        self.gridLayout.addWidget(self.btn_add_material_1c, 20, 0, 1, 4)

        self.in_1c_plug = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_plug.setObjectName(u"in_1c_plug")
        self.in_1c_plug.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_plug.setDecimals(1)
        self.in_1c_plug.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_plug, 5, 3, 1, 1)

        self.in_1c_vertical = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_vertical.setObjectName(u"in_1c_vertical")
        self.in_1c_vertical.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_vertical.setDecimals(1)
        self.in_1c_vertical.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_vertical, 10, 3, 1, 1)

        self.bin_1c_top_profile = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_top_profile.setObjectName(u"bin_1c_top_profile")
        sizePolicy5.setHeightForWidth(self.bin_1c_top_profile.sizePolicy().hasHeightForWidth())
        self.bin_1c_top_profile.setSizePolicy(sizePolicy5)
        self.bin_1c_top_profile.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_top_profile, 7, 2, 1, 1)

        self.bin_1c_sealant = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_sealant.setObjectName(u"bin_1c_sealant")
        sizePolicy5.setHeightForWidth(self.bin_1c_sealant.sizePolicy().hasHeightForWidth())
        self.bin_1c_sealant.setSizePolicy(sizePolicy5)
        self.bin_1c_sealant.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_sealant, 14, 2, 1, 1)

        self.btn_add_service_1c = QPushButton(self.scrollAreaWidgetContents_2)
        self.btn_add_service_1c.setObjectName(u"btn_add_service_1c")
        self.btn_add_service_1c.setIcon(icon8)

        self.gridLayout.addWidget(self.btn_add_service_1c, 25, 0, 1, 4)

        self.bin_1c_rollers = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_rollers.setObjectName(u"bin_1c_rollers")
        sizePolicy5.setHeightForWidth(self.bin_1c_rollers.sizePolicy().hasHeightForWidth())
        self.bin_1c_rollers.setSizePolicy(sizePolicy5)
        self.bin_1c_rollers.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_rollers, 15, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.additional_nomenclature_widget_2, 24, 0, 1, 4)
        ...
        self.bin_shlegel = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_shlegel.setObjectName(u"bin_shlegel")
        sizePolicy5.setHeightForWidth(self.bin_shlegel.sizePolicy().hasHeightForWidth())
        self.bin_shlegel.setSizePolicy(sizePolicy5)
        self.bin_shlegel.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_shlegel, 16, 2, 1, 1)
        ...
        self.in_1c_rollers = QSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_rollers.setObjectName(u"in_1c_rollers")
        self.in_1c_rollers.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_rollers.setMaximum(9999)

        self.gridLayout.addWidget(self.in_1c_rollers, 15, 3, 1, 1)

        self.in_1c_rigel = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_rigel.setObjectName(u"in_1c_rigel")
        self.in_1c_rigel.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_rigel.setDecimals(1)
        self.in_1c_rigel.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_rigel, 9, 3, 1, 1)
        ...
        self.in_1c_bot_guide = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_bot_guide.setObjectName(u"in_1c_bot_guide")
        self.in_1c_bot_guide.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_bot_guide.setDecimals(1)
        self.in_1c_bot_guide.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_bot_guide, 2, 3, 1, 1)

        self.in_1c_decor = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_decor.setObjectName(u"in_1c_decor")
        self.in_1c_decor.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_decor.setDecimals(1)
        self.in_1c_decor.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_decor, 4, 3, 1, 1)

        self.in_1c_bot_profile = QDoubleSpinBox(self.scrollAreaWidgetContents_2)
        self.in_1c_bot_profile.setObjectName(u"in_1c_bot_profile")
        self.in_1c_bot_profile.setButtonSymbols(QAbstractSpinBox.NoButtons)
        self.in_1c_bot_profile.setDecimals(1)
        self.in_1c_bot_profile.setMaximum(9999.000000000000000)

        self.gridLayout.addWidget(self.in_1c_bot_profile, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.color_25, 21, 0, 1, 4)

        self.bin_1c_rigel = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_rigel.setObjectName(u"bin_1c_rigel")
        sizePolicy5.setHeightForWidth(self.bin_1c_rigel.sizePolicy().hasHeightForWidth())
        self.bin_1c_rigel.setSizePolicy(sizePolicy5)
        self.bin_1c_rigel.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_rigel, 9, 2, 1, 1)

        self.bin_1c_top_movable = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_top_movable.setObjectName(u"bin_1c_top_movable")
        sizePolicy5.setHeightForWidth(self.bin_1c_top_movable.sizePolicy().hasHeightForWidth())
        self.bin_1c_top_movable.setSizePolicy(sizePolicy5)
        self.bin_1c_top_movable.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_top_movable, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.color_26, 26, 0, 1, 4)

        self.bin_1c_top_guide = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_top_guide.setObjectName(u"bin_1c_top_guide")
        sizePolicy5.setHeightForWidth(self.bin_1c_top_guide.sizePolicy().hasHeightForWidth())
        self.bin_1c_top_guide.setSizePolicy(sizePolicy5)
        self.bin_1c_top_guide.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_top_guide, 1, 2, 1, 1)
        ...
        self.bin_1c_decor = QPushButton(self.scrollAreaWidgetContents_2)
        self.bin_1c_decor.setObjectName(u"bin_1c_decor")
        sizePolicy5.setHeightForWidth(self.bin_1c_decor.sizePolicy().hasHeightForWidth())
        self.bin_1c_decor.setSizePolicy(sizePolicy5)
        self.bin_1c_decor.setAutoDefault(False)

        self.gridLayout.addWidget(self.bin_1c_decor, 4, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.l_widget, 1, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 611, 501))
        ...
        self.gridLayout_5.addWidget(self.scrollArea, 1, 1, 1, 1)
        ...
        icon9 = QIcon()
        icon9.addFile(u"icons/apps.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.r_merge.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u"icons/arrows.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.r_unmerge.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u"icons/palette.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.r_material.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u"icons/trash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.r_delete_door.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u"icons/edit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.r_edit_door.setIcon(icon13)
        ...
        self.gridLayout_5.addWidget(self.bottom_widget, 2, 0, 1, 2)
    ...
    def retranslateUi(self, OrderTab):
        ...
        self.btn_clone.setText(QCoreApplication.translate("OrderTab", u"\u0421\u043e\u0437\u0434\u0430\u0442\u044c \u043a\u043e\u043f\u0438\u044e", None))
        ...
        self.discription_5.setText(QCoreApplication.translate("OrderTab", u"\u041e\u0411\u0429\u0410\u042f \u0418\u041d\u0424\u041e\u0420\u041c\u0410\u0426\u0418\u042f", None))
        ...
        self.bin_1c_bot_profile.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.bin_1c_bot_guide.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.color_18.setText(QCoreApplication.translate("OrderTab", u"\u0420\u041e\u041b\u0418\u041a\u0418", None))
        self.color_15.setText(QCoreApplication.translate("OrderTab", u"\u0423\u041f\u041b\u041e\u0422\u041d\u0418", None))
        self.color_13.setText(QCoreApplication.translate("OrderTab", u"\u0412\u0415\u0420\u0422\u0418\u041a\u0410\u041b", None))
        self.color_27.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.bin_1c_vertical.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.bin_1c_plug.setText(QCoreApplication.translate("OrderTab", u"...", None))
        ...
        self.btn_add_material_1c.setText(QCoreApplication.translate("OrderTab", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043c\u0430\u0442\u0435\u0440\u0438\u0430\u043b", None))
        self.bin_1c_top_profile.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.bin_1c_sealant.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.btn_add_service_1c.setText(QCoreApplication.translate("OrderTab", u"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u0443\u0441\u043b\u0443\u0433\u0443", None))
        self.bin_1c_rollers.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.color_6.setText(QCoreApplication.translate("OrderTab", u"\u0425\u041e\u0414\u041e\u0412\u041e\u0419", None))
        self.bin_shlegel.setText(QCoreApplication.translate("OrderTab", u"...", None))
        ...
        self.bin_1c_rigel.setText(QCoreApplication.translate("OrderTab", u"...", None))
        self.bin_1c_top_movable.setText(QCoreApplication.translate("OrderTab", u"...", None))
        ...
        self.bin_1c_top_guide.setText(QCoreApplication.translate("OrderTab", u"...", None))
        ...
        self.bin_1c_decor.setText(QCoreApplication.translate("OrderTab", u"...", None))
